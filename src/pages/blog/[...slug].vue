    ...
    <ContentDoc v-slot="{ doc }">
      ...
      <div class="border-b-2 text-zinc-600 text-xs pb-4 mb-4">
        <p class="mb-2">
          ...
          <span class="border-b ml-1">{{ doc.created_at }}</span>
        </p>
        <p>
          ...
          <span
            ...
            :key="i"
            class="bg-zinc-200 border-b px-1 py-0.5 mx-1 rounded leading-none"
            >{{ tag }}</span
          >
        </p>
      </div>
...
.markdown-body {
  color-scheme: light;
  --color-md-text: #27272a;

  --color-prettylights-syntax-comment: #6e7781;
  --color-prettylights-syntax-constant: #4338ca;
  --color-prettylights-syntax-entity: #8250df;
  --color-prettylights-syntax-storage-modifier-import: #24292f;
  --color-prettylights-syntax-entity-tag: #116329;
  --color-prettylights-syntax-keyword: #cf222e;
  --color-prettylights-syntax-string: #4338ca;
  ...
  --color-prettylights-syntax-markup-heading: #4338ca;
  ...
  --color-prettylights-syntax-markup-ignored-bg: #4338ca;
  --color-prettylights-syntax-meta-diff-range: #8250df;
  --color-prettylights-syntax-brackethighlighter-angle: #57606a;
  --color-prettylights-syntax-sublimelinter-gutter-mark: #8c959f;
  --color-prettylights-syntax-constant-other-reference-link: #4338ca;
...
.markdown-body h3:hover a:before,
.markdown-body h4:hover a:before,
.markdown-body h5:hover a:before,
.markdown-body h6:hover a:before {
  position: absolute;
  top: 25%;
  left: -14px;
  content: "";
